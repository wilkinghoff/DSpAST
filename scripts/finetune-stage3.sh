...
# Download from ...
ckpt=/path_to_models/finetune-stage3.pth
# or use your own checkpoint:
ckpt=./outputs/finetune-stage2/checkpoint-49.pth
...
# logging path
output_dir=./outputs/finetune-stage3
...
python -m torch.distributed.launch \
    ...
    --first_eval_ep 0 --epochs 50 --warmup_epochs 10 --epoch_len 18617 \
