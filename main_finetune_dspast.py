...
import dspast
from engine_finetune_dspast import evaluate, train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--sed_weight', type=float, default=1,
                        help='Weight for SED loss')
    parser.add_argument('--dp_weight', type=float, default=1,
                        help='Weight for DP loss')
    parser.add_argument('--doae_weight', type=float, default=1,
                        help='Weight for DOAE loss')
...
def main(args):
    ...
    model = dspast.__dict__[args.model](
...
if __name__ == '__main__':
    #warnings.simplefilter('error', RuntimeWarning)  # localize warnings for debugging purposes
